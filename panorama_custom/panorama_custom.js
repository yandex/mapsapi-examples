ymaps.ready(function () {
    // To begin with, we have to check whether the user's browser
    // supports the panorama player.
    ...
    function Panorama () {
        ...
        // Our panorama will have two zoom levels for
        // the panorama image: low quality and high quality.
        this._tileLevels = [
    ...
    // Inheriting the panorama class from ymaps.panorama.Base,
    // which partially implements IPanoramaTileLevel for us.
