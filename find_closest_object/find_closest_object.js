...
function init() {
    ...
    // Cafe descriptions can be stored in JSON format, in order to then generate geo objects
    // from the descriptions using ymaps.geoQuery.
    cafe = ymaps.geoQuery({
    ...
    }).addToMap(myMap); // Adding points to the map immediately.
